...
.. toctree::
   ...
   ./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Select_Models
   ./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Generate_Datasets
   ./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Select_Environment
   Optimize Model Performance <./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Int_8_Quantization>
   Explore Inference Configurations <./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Run_Inference>
   Visualize Model Output <./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Visualize_Accuracy>
   ./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Measure_Accuracy
   Create Deployment Package <./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Deployment_Package>
   ./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Export_Project
   Learn OpenVINO in DL Workbench <./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Jupyter_Notebooks_CLI>
   Restore DL Workbench State <./_workbench-files-to-migrate/workbench_docs_Workbench_DG_Persist_Database>
   Run DL Workbench Securely <./_workbench-files-to-migrate/workbench_docs_security_Workbench>
