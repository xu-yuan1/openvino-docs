...
.. _doxid-openvino_docs_ops_reduction__reduce_l1_4:


ReduceL1
========

:target:`doxid-openvino_docs_ops_reduction__reduce_l1_4_1md_openvino_docs_ops_reduction_reducel1_4` **Versioned name** : *ReduceL1-4*
...
#. If ``axes`` is an empty list, *ReduceL1* corresponds to the identity operation.
