.. index:: pair: page; ReduceSum
.. _doxid-openvino_docs_ops_reduction__reduce_sum_1:


ReduceSum
=========

:target:`doxid-openvino_docs_ops_reduction__reduce_sum_1_1md_openvino_docs_ops_reduction_reducesum_1` **Versioned name** : *ReduceSum-1*
...
#. If ``axes`` is an empty list, *ReduceSum* corresponds to the identity operation.
