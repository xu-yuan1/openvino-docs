.. index:: pair: page; ReduceLogicalOr
.. _doxid-openvino_docs_ops_reduction__reduce_logical_or_1:


ReduceLogicalOr
===============

:target:`doxid-openvino_docs_ops_reduction__reduce_logical_or_1_1md_openvino_docs_ops_reduction_reducelogicalor_1` **Versioned name** : *ReduceLogicalOr-1*
...
#. If ``axes`` is an empty list, *ReduceLogicalOr* corresponds to the identity operation.
